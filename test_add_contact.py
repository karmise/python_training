...
def fill_contact_page(wd, contact):
...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        fill_contact_page(wd, Contact(firstname="tqwet", middlename="twet", lastname="sdgsg", nickname="fsdfsdf",
                                      title="fasfa",
    ...
    def test_add_empty_contact(self):
        ...
        login(wd, username="admin", password="secret")
        add_new_contact_page(wd)
        fill_contact_page(wd, Contact(firstname="", middlename="", lastname="", nickname="", title="", company="",
